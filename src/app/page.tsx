    ...
    <div className="animate-fade-in">
      ...
      {showDonationModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          {/* Modal Container */}
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-card border border-border/80 shadow-2xl shadow-primary/10 animate-scale-in p-6 z-10">
